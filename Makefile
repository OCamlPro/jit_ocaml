...
libscijit_ocaml_la_DEPENDENCIES = libscijit_ocaml-runtime.a
am__objects_1 = libscijit_ocaml_la-serialize_visitor.lo \
	libscijit_ocaml_la-jit_ocaml.lo
...
JIT_OCAML_CPP_SOURCES = \
			src/cpp/serialize_visitor.cpp \
			src/cpp/jit_ocaml.cpp
...
libscijit_ocaml_la_LIBADD = libscijit_ocaml-runtime.a
...
include ./$(DEPDIR)/libscijit_ocaml_la-jit_ocaml.Plo
include ./$(DEPDIR)/libscijit_ocaml_la-serialize_visitor.Plo
...
libscijit_ocaml_la-serialize_visitor.lo: src/cpp/serialize_visitor.cpp
	$(LIBTOOL)  --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libscijit_ocaml_la_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -MT libscijit_ocaml_la-serialize_visitor.lo -MD -MP -MF $(DEPDIR)/libscijit_ocaml_la-serialize_visitor.Tpo -c -o libscijit_ocaml_la-serialize_visitor.lo `test -f 'src/cpp/serialize_visitor.cpp' || echo '$(srcdir)/'`src/cpp/serialize_visitor.cpp
	$(am__mv) $(DEPDIR)/libscijit_ocaml_la-serialize_visitor.Tpo $(DEPDIR)/libscijit_ocaml_la-serialize_visitor.Plo
#	source='src/cpp/serialize_visitor.cpp' object='libscijit_ocaml_la-serialize_visitor.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(LIBTOOL)  --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libscijit_ocaml_la_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o libscijit_ocaml_la-serialize_visitor.lo `test -f 'src/cpp/serialize_visitor.cpp' || echo '$(srcdir)/'`src/cpp/serialize_visitor.cpp

libscijit_ocaml_la-jit_ocaml.lo: src/cpp/jit_ocaml.cpp
	$(LIBTOOL)  --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libscijit_ocaml_la_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -MT libscijit_ocaml_la-jit_ocaml.lo -MD -MP -MF $(DEPDIR)/libscijit_ocaml_la-jit_ocaml.Tpo -c -o libscijit_ocaml_la-jit_ocaml.lo `test -f 'src/cpp/jit_ocaml.cpp' || echo '$(srcdir)/'`src/cpp/jit_ocaml.cpp
	$(am__mv) $(DEPDIR)/libscijit_ocaml_la-jit_ocaml.Tpo $(DEPDIR)/libscijit_ocaml_la-jit_ocaml.Plo
#	source='src/cpp/jit_ocaml.cpp' object='libscijit_ocaml_la-jit_ocaml.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(LIBTOOL)  --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libscijit_ocaml_la_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o libscijit_ocaml_la-jit_ocaml.lo `test -f 'src/cpp/jit_ocaml.cpp' || echo '$(srcdir)/'`src/cpp/jit_ocaml.cpp
